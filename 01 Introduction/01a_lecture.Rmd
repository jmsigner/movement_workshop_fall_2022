...
- The course is scheduled from Monday (14th of Nov) to Friday (18th of Nov) from 2pm to 6pm Berlin time.

- We split these 4h block into two chunks, each roughly structered like this: 
  - Lecture ~ 45 min
...
We will mainly use the `amt` package, but also occassionally other packages for movement analysis. 
...
- We would recommend to download the whole repository from GitHub (https://github.com/jmsigner/movement_workshop_fall_2022)^[If you are familiar with git, feel free to clone the repository]. 
