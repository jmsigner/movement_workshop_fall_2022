...
# I still have some namespace issues. Hence, you will have to source some of the
# functions
source("https://raw.githubusercontent.com/jmsigner/amt/master/R/simulate.R")
...
k1 <- redistribution_kernel(m_0, map = raster::stack(env), start = start)
k1
...
# This failed, because the animal stepped out of the landscape, lets try again
# with fewer steps.
tictoc::tic()
s1 <- simulate_path(k1, n.steps = 200)
tictoc::toc()
